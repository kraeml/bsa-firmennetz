...
name_items = [ "server01", "server01." + search_itmes[0] ]


# you add controls here
control 'network-PC1-1.0' do                        # A unique ID for this control
  impact 0.7                                # The criticality, if this control fails.
  title 'Network into pr-network'             # A human-readable title
